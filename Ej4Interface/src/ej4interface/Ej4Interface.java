...
/**
 *Ej 4 - Se plantea desarrollar un programa que nos permita calcular el área y el perímetro
...
public class Ej4Interface {
    ...
    public static void main(String[] args) {
        ...
        fg.calcularAreaCirculo();
        fg.calcularPerimetroCirculo();
        fg.calcularAreaRectangulo();
        fg.calcularPerimetroRectangulo();
